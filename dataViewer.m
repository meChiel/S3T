function dataViewer()
global plateFilename plateDir responses detailFilename defaultDir currentFile fittt histtt
bgc=[0.5 0.5 0.5];
f3 = figure('Visible','on','name','S3T: Data Viewer',...
    'Color',bgc,...
    'NumberTitle','off');
openFilesBtn = uicontrol('Style', 'pushbutton', 'String', 'Open File!',...
    'Position', [5+50 (10) 50 20],...
    'Backgroundcolor',bgc,...
    ...
    function openFiles(plateFilename2,plateDir)
        ...
        doFilterBtn = uicontrol('Style', 'pushbutton', 'String', 'Filter',...
           ...
           fitBtn = uicontrol('Style', 'pushbutton', 'String', 'Fit',...
                'Position', [5+50+50+50+50 10 50 20],...
                'Backgroundcolor',bgc,...
                'Callback', @fitt);
            
              HistBtn = uicontrol('Style', 'pushbutton', 'String', 'Hist',...
                'Position', [5+50+50+50+50+50 10 50 20],...
                'Backgroundcolor',bgc,...
                'Callback', @histt);
