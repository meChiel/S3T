    ...
    function startUp()
        ...
        function createCheckBoxes()
            ...
            reuseMaskChkButton = uicontrol('Style','checkbox','Value',0,...
                'Position',[20 by(-1)+2.5 100 15],'String','reuse Mask');
        end
 ...
 'F:\share\toBeProcessed\GCAMP\NS_820180504_151837_20180504_153852'
    ...
    function processDir(datadirname)
        ...
        for iii = 1:length(experiments)
           ...
           [data, pathname, fname, dirname] = loadTiff([expnm{iii}.folder '\' expnm{iii}.name]);
            defaultDir = dirname;
...
cleanBW();
    ...
    function invalidate()
        ...
        mASR=0; miASR=0; fps=fps; UpHalfTime=0; DownHalfTime=0; expEqUp=0; expEqDown=0; tau1 = 0; ampSS=0; nSynapses=0; error=1;AUC=0;nAUC=0;
        t =array2table([mASR miASR fps UpHalfTime DownHalfTime tau1 ampSS nSynapses AUC nAUC error ],'VariableNAmes',{'peakAmp', 'miASR', 'fps', 'UpHalfTime', 'downHalfTime', 'tau1', 'ampSS','nSynapses','AUC', 'nAUC','error'});
