...
function [A, fname, FileName, PathName]=loadTiff(fname)
%fname = '../../data/Experiment 5_SyG 10AP.tif';
global defaultDir
if nargin<1
    [FileName,PathName] = uigetfile('*.tif','Select the MATLAB code file',defaultDir);
...
if extra
    ...
    plot(ss);
    axis off    
    savesubplot(4,4,10,[fname '_temp.png']);
