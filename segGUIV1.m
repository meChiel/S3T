...
if nargin>0
    ...
    %%%   javaFrame.setFigureIcon(javax.swing.ImageIcon('my_icon.png'));
       ...
       pp= uicontrol('Style', 'Frame', 'String', ' ',...
                    'Position', [10 by(1.5) 170 180],...
                    'BackgroundColor',bgc, 'ForegroundColor',[.05 .05 .08]);% ,...
                    %'EdgeColor',[.15 .05 .08] );
    
       pp= uicontrol('Style', 'Frame', 'String', ' ',...
                    'Position', [10 by(-8.5) 170 170],...
                    'BackgroundColor',bgc, 'ForegroundColor',[.05 .05 .08]);% ,...
                    %'EdgeColor',[.15 .05 .08] );
        if fullVersion
            createListArray();
        ...
        function createPushButtons
            ...
            uicontrol('Style', 'text', 'FontWeight','bold','FontAngle','Italic','String', 'Analysis Settings',...
                'Position', [20 by(-6) 150 20],...
                'BackgroundColor',bgc);
 ...
 %               'Position', [20+50 by(-5) 200 200]...
  %              );
   ...
   % 'Position',[70 by(-5) 200 200]);
        ...
        createPushButtons();
        createCheckBoxes();
          uicontrol('Style', 'text', 'FontWeight','bold','FontAngle','Italic','String', 'Threshold Settings',...
                'Position', [20 by(-15) 150 20],...
                'BackgroundColor',bgc);
